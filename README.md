...
The premium packages are versioned `1.0.3-1` and include PreferenceLoader panes in Settings. They install disabled by default so they can be enabled and tested one at a time.
